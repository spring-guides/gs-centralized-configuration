...
You will set up a
http://cloud.spring.io/spring-cloud-config/spring-cloud-config.html[Config Server] and
...
only the Config Server dependency. The following image shows the Initializr set up for the
configuration service:

image::images/initializr-service.jpg[]
...
`centralized-configuration-service` as the Group and Artifact, respectively. You will use
...
Actuator, and Spring Web dependencies. The following image  shows the Initializr set up
for the configuration client:

image::images/initializr-client.jpg[]

NOTE: The preceding image shows the Initializr with Maven chosen as the build tool. You
can also use Gradle. It also shows values of `com.example` and
`centralized-configuration-client` as the Group and Artifact, respectively. You will use
those values throughout the rest of this sample.
...
`configuration-service/src/main/java/com/example/configurationservice/ConfigServiceApplication.java`)
shows such an application:

====
[source,java]
----
include::complete/configuration-service/src/main/java/com/example/configurationservice/ConfigServiceApplication.java[]
----
====
